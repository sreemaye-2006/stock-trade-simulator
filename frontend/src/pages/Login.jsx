      ...
      <div className="max-w-md w-full space-y-8 p-8 rounded-2xl border shadow-xl transition-all duration-300 bg-slate-800 border-slate-700 shadow-slate-950/50">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="group relative w-full flex justify-center py-2.5 px-4 border border-transparent text-sm font-medium rounded-lg text-white transition-colors bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500"
            >
              Sign in
            </button>
          </div>
