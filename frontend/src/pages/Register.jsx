    ...
    <div className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className={`max-w-md w-full space-y-8 p-8 rounded-2xl border shadow-xl transition-all duration-300 ${darkMode ? 'bg-slate-800 border-slate-700 shadow-slate-950/50' : 'bg-white border-slate-200 shadow-slate-200/50'}`}>
        <div className="text-center">
          ...
          <h2 className={`mt-6 text-3xl font-extrabold ${darkMode ? 'text-white' : 'text-slate-900'}`}>Create an account</h2>
        ...
        {success && (
          <div className="bg-green-500/10 border border-green-500/50 text-green-550 p-3 rounded-lg text-sm text-center">
